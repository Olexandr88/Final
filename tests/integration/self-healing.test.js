...
describe('Self-Healing Integration Tests', { skip: true }, () => {
  ...
  describe('Health Monitoring', () => {
    ...
    it(
      'should validate multiple service health',
      async () => {
  ...
  describe('Auto-Recovery Mechanisms', () => {
    ...
    it(
      'should support manual recovery trigger',
      async () => {
  ...
  describe('Failure Recovery', () => {
    ...
    it(
      'should validate agent registration failures',
      async () => {
    ...
    it(
      'should maintain service availability during errors',
      async () => {
        // Send multiple invalid requests
        const requests = [];
        for (let i = 0; i < 5; i++) {
          requests.push(
            fetch(`${A2A_SERVER_URL}/invalid-endpoint`).catch((err) => ({ error: true }))
          );
        }
  ...
  describe('Recovery Validation', () => {
    ...
    it(
      'should track agent registry health',
      async () => {
