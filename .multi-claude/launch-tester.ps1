# Tester Claude Launcher - Task Monitoring Version

# Change to project directory
Set-Location "C:\Users\scarm"

$host.ui.RawUI.WindowTitle = "Tester Claude - Claude Code CLI"

Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor yellow
Write-Host "  TESTER CLAUDE - TASK MONITOR" -ForegroundColor yellow
Write-Host "  Instance ID: tester" -ForegroundColor yellow
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor yellow
Write-Host ""
...
$status | Out-File -FilePath ".multi-claude/status-tester.json" -Encoding utf8

Write-Host "✓ Status initialized" -ForegroundColor Green
Write-Host "✓ Ready to receive tasks" -ForegroundColor Green
Write-Host ""
Write-Host "📋 Role: .multi-claude/claude-tester-task.md" -ForegroundColor Cyan
Write-Host "📊 Status: .multi-claude/status-tester.json" -ForegroundColor Cyan
Write-Host "📥 Tasks: .multi-claude/tasks/tester-current-task.md" -ForegroundColor Cyan
Write-Host ""

# Display role definition
Write-Host "━━━ ROLE DEFINITION ━━━" -ForegroundColor Yellow
Get-Content ".multi-claude/claude-tester-task.md" | ForEach-Object { Write-Host $_ -ForegroundColor Gray }
Write-Host ""
Write-Host "━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Yellow
Write-Host ""

# Task monitoring loop
$taskFile = ".multi-claude/tasks/tester-current-task.md"
$lastProcessed = $null
...
while ($true) {
    if (Test-Path $taskFile) {
        ...
        if ($lastProcessed -eq $null -or $currentModified -gt $lastProcessed) {
            ...
            $prompt = @"
You are the Tester Claude in a multi-Claude coordination system.

ROLE:
$(Get-Content ".multi-claude/claude-tester-task.md" -Raw)
...
2. Update .multi-claude/status-tester.json with progress
