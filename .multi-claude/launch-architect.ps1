# Architect Claude Launcher - Task Monitoring Version

# Change to project directory
Set-Location "C:\Users\scarm"

$host.ui.RawUI.WindowTitle = "Architect Claude - Claude Code CLI"

Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor cyan
Write-Host "  ARCHITECT CLAUDE - TASK MONITOR" -ForegroundColor cyan
Write-Host "  Instance ID: architect" -ForegroundColor cyan
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor cyan
Write-Host ""
...
$status | Out-File -FilePath ".multi-claude/status-architect.json" -Encoding utf8

Write-Host "✓ Status initialized" -ForegroundColor Green
Write-Host "✓ Ready to receive tasks" -ForegroundColor Green
Write-Host ""
Write-Host "📋 Role: .multi-claude/claude-architect-task.md" -ForegroundColor Cyan
Write-Host "📊 Status: .multi-claude/status-architect.json" -ForegroundColor Cyan
Write-Host "📥 Tasks: .multi-claude/tasks/architect-current-task.md" -ForegroundColor Cyan
Write-Host ""

# Display role definition
Write-Host "━━━ ROLE DEFINITION ━━━" -ForegroundColor Yellow
Get-Content ".multi-claude/claude-architect-task.md" | ForEach-Object { Write-Host $_ -ForegroundColor Gray }
Write-Host ""
Write-Host "━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Yellow
Write-Host ""

# Task monitoring loop
$taskFile = ".multi-claude/tasks/architect-current-task.md"
$lastProcessed = $null
...
while ($true) {
    if (Test-Path $taskFile) {
        ...
        if ($lastProcessed -eq $null -or $currentModified -gt $lastProcessed) {
            ...
            $prompt = @"
You are the Architect Claude in a multi-Claude coordination system.

ROLE:
$(Get-Content ".multi-claude/claude-architect-task.md" -Raw)
...
2. Update .multi-claude/status-architect.json with progress
