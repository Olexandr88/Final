...
OPTIMIZED VERSION with chunked hashing and size-filtered duplicate detection
"""
...
class FileTools:
    ...
    def _validate_path(path_str: str) -> Path:
        ...
        try:
            ...
            for base_dir in FileTools.ALLOWED_BASE_DIRS:
                try:
            ...
            raise ValueError(
                ...
                f'Allowed: {", ".join(str(d) for d in FileTools.ALLOWED_BASE_DIRS)}'
            )
        except Exception as e:
            if isinstance(e, ValueError) and 'Access denied' in str(e):
                raise
    ...
    def search_files(directory: str, pattern: str, max_depth: int = 3) -> Dict[str, Any]:
        ...
        try:
            ...
            directory_path = FileTools._validate_path(directory)
            ...
            return {
                'success': False,
                'error': sanitize_error(e, 'file_operation')
            }

    @staticmethod
    def get_stats(target_path: str) -> Dict[str, Any]:
    ...
    def batch_rename(directory: str, pattern: str, replacement: str, dry_run: bool = True) -> Dict[str, Any]:
        ...
        try:
            # SECURITY: Validate path before accessing
            path = FileTools._validate_path(directory)
    ...
    @staticmethod
    def _hash_file_chunked(file_path: Path, algorithm: str = 'sha256') -> str:
        """
        OPTIMIZATION 2 + SECURITY FIX: Chunked file hashing with SHA-256
        - 99% memory reduction (64KB chunks)
        - Secure hash algorithm (SHA-256 instead of MD5)
    ...
    def find_duplicates(directory: str, max_depth: int = 3) -> Dict[str, Any]:
        ...
        """
        try:
            # SECURITY: Validate file access and size limits
            ...
            collect_files(directory_path, 0)
