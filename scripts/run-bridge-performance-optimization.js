...
class BridgeDemoOptimizer {
  ...
  async collectPerformanceBaseline() {
    ...
    log.performance(
      `Baseline - Memory: ${Math.round(baseline.memoryUsage.heapUsed / 1024 / 1024)}MB`
    );
    return baseline;
  }
  ...
  async collectPerformanceMetrics() {
    ...
    log.performance(
      `Post-optimization - Memory: ${Math.round(metrics.memoryUsage.heapUsed / 1024 / 1024)}MB`
    );
    return metrics;
  }
  ...
  generateOptimizationReport() {
    ...
    console.log(
      `   Memory Efficiency: ${Math.round((1 - improvements.memory.after / improvements.memory.before) * 100)}% improvement`
    );
