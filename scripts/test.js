...
exec('node scripts/scraper.js https://example.com', (error, stdout, stderr) => {
  if (error) {
  ...
  if (stdout.includes('Links:')) {
    console.log('  ✓ Scraper output contains "Links:"');
  } else {
    console.error('  ✗ Scraper output does not contain "Links:"');
  }
});
